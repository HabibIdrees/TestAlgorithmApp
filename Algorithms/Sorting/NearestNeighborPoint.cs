...
namespace TestAlgorithmApp.Algorithms.Sorting
{
    public class Point
    {
        public int x, y;
    ...
    public class DistanceComparator : IComparer<Point>
    {
        Point c;
    ...
    {
        PriorityQueue<Point> pQueue = new PriorityQueue<Point>(k + 1, new DistanceComparator(c));
        for (Point p : points)
        {
